 ...
 */
export function routerListChatCompletions(
  client: SudoCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListChatCompletionsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["401", "4XX", "500", "502", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ChatCompletionList$inboundSchema),
